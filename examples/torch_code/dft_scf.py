...
W0 = torch.as_tensor(init_W(H_atom, seed)).requires_grad_(True).to(DEVICE)
dE_dW = compute_grad(lambda _dW0: energy_of_W(_dW0, H_atom, ionic_potential0, Eewald0), W0)
physika_print(dE_dW[int(0)])
E_total = runSCF(H_atom, Eewald0, Nit, β, etol, seed)
physika_print(E_total)