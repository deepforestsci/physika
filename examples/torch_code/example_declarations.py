...
r_vector = torch.tensor([1.0, 2.0, 3.0], device='cpu')
r_matrix = torch.tensor([[1.0, 2.0], [3.0, 4.0]], device='cpu')
...
z_vector = torch.tensor([1, 2, 3], device='cpu')
...
n_vector = torch.tensor([0, 1, 2, 3], device='cpu')
