...
def get_E(scf):
    ...
    Een = get_Een(scf.n, scf.ionic_potential)
...
φ0 = get_phi(H_atom, n0)
n0_c = ((n0 + 1e-10) * (1.0 + 0j))
ex_vx0 = lda_x(n0_c)
ec_vc0 = lda_c_chachiyo(n0_c)
exc0 = (ex_vx0[int(0)] + ec_vc0[int(0)])
vxc0 = (ex_vx0[int(1)] + ec_vc0[int(1)])
ionic_potential0 = coulomb(H_atom)
gcut = 2.0
gamma = 1e-08
Eewald0 = get_Eewald(H_atom, gcut, gamma)
Ekin0 = get_Ekin(H_atom, Y0)
Ecoul0 = get_Ecoul(H_atom, n0, φ0)
Exc0 = get_Exc(H_atom, n0, exc0)
Een0 = get_Een(n0, ionic_potential0)
E0 = ((((Ekin0 + Ecoul0) + Exc0) + Een0) + Eewald0)
physika_print(Ekin0)
physika_print(Ecoul0)
physika_print(Exc0)
physika_print(Een0)
physika_print(Eewald0)
physika_print(E0)