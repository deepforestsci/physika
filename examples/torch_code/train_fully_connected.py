...
# === Program ===
X = torch.stack([torch.as_tensor(torch.stack([torch.as_tensor(torch.stack([torch.as_tensor(1.0)])), torch.as_tensor(torch.stack([torch.as_tensor(0.0)])), torch.as_tensor(torch.stack([torch.as_tensor(0.0)]))])), torch.as_tensor(torch.stack([torch.as_tensor(torch.stack([torch.as_tensor(0.0)])), torch.as_tensor(torch.stack([torch.as_tensor(1.0)])), torch.as_tensor(torch.stack([torch.as_tensor(0.0)]))])), torch.as_tensor(torch.stack([torch.as_tensor(torch.stack([torch.as_tensor(0.0)])), torch.as_tensor(torch.stack([torch.as_tensor(0.0)])), torch.as_tensor(torch.stack([torch.as_tensor(1.0)]))])), torch.as_tensor(torch.stack([torch.as_tensor(torch.stack([torch.as_tensor(1.0)])), torch.as_tensor(torch.stack([torch.as_tensor(1.0)])), torch.as_tensor(torch.stack([torch.as_tensor(1.0)]))]))])
y = torch.stack([torch.as_tensor(0.2), torch.as_tensor(0.4), torch.as_tensor(0.6), torch.as_tensor(0.9)])
