...
dt = 0.01
solver = RK4(dt)
physika_print(solver(torch.tensor([0.5, 0.0], device=DEVICE)))
physika_print(solver(torch.tensor([1.0, 0.0], device=DEVICE)))
step = RK4(dt)
simulate(step, torch.tensor([0.5, 0.0], device=DEVICE), 1000, dt)