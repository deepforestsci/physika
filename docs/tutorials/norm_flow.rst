...
.. code-block:: python
    ...
    class RealNVP:
        ...
        def update_params(lr: ℝ, learnable_grads: ℝ[m]):
            this.W1a_s = this.W1a_s - lr * learnable_grads[0]
            this.b1a_s = this.b1a_s - lr * learnable_grads[1]
            this.W2a_s = this.W2a_s - lr * learnable_grads[2]
            this.b2a_s = this.b2a_s - lr * learnable_grads[3]
            this.W1a_m = this.W1a_m - lr * learnable_grads[4]
            this.b1a_m = this.b1a_m - lr * learnable_grads[5]
            this.W2a_m = this.W2a_m - lr * learnable_grads[6]
            this.b2a_m = this.b2a_m - lr * learnable_grads[7]
            this.W1b_s = this.W1b_s - lr * learnable_grads[8]
            this.b1b_s = this.b1b_s - lr * learnable_grads[9]
            this.W2b_s = this.W2b_s - lr * learnable_grads[10]
            this.b2b_s = this.b2b_s - lr * learnable_grads[11]
            this.W1b_m = this.W1b_m - lr * learnable_grads[12]
            this.b1b_m = this.b1b_m - lr * learnable_grads[13]
            this.W2b_m = this.W2b_m - lr * learnable_grads[14]
            this.b2b_m = this.b2b_m - lr * learnable_grads[15]
    ...
    realnvp: RealNVP = RealNVP(W1a_s, b1a_s, W2a_s, b2a_s, W1a_m, b1a_m, W2a_m, b2a_m, W1b_s, b1b_s, W2b_s, b2b_s, W1b_m, b1b_m, W2b_m, b2b_m, n, d)
    print(DEVICE)
